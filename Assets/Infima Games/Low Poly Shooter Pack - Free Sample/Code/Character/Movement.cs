...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Movement : MovementBehaviour
    {
        ...
        [SerializeField]
        private float speedWalking = 3.8f;

        [Tooltip("How fast the player moves while running."), SerializeField]
        private float speedRunning = 3.8f;
        ...
        private void MoveCharacter()
        {
            ...
            movement *= Mathf.Max(0f, externalSpeedMultiplier);
        ...
        public float GetExternalSpeedMultiplier() => externalSpeedMultiplier;
